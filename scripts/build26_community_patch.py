...
replace_once(admin, "import '../../core/api/hdc_workflow_api_client.dart';\n", "import '../../core/api/hdc_workflow_api_client.dart';\nimport '../../providers/hdc_community_provider.dart';\n")
replace_once(
    admin,
