...
BRANCH_WORKFLOW = Path('.github/workflows/build24-2-wiring.yml')
...
# Authentication contract: public registration now requires a catalog location.
for path in [
    'lib/core/auth/auth_gateway.dart',
    'lib/core/auth/hdc_api_auth_gateway.dart',
    'lib/core/auth/unavailable_auth_gateway.dart',
    'lib/core/auth/auth_service.dart',
    'lib/providers/hdc_auth_provider.dart',
]:
    replace_once(
        path,
...
# Service requests use the same selection-only catalog.
replace_once(
...
# Shared and role profiles cannot persist arbitrary locations.
replace_once(
    'lib/features/profiles/member_profile_edit_screen.dart',
    "import '../../core/ui/hdc_colors.dart';",
    "import '../../core/ui/hdc_colors.dart';\nimport '../../core/ui/hdc_location_picker.dart';",
)
replace_once(
...
replace_once(
    'lib/features/profiles/role_profile_edit_screen.dart',
    "import '../../core/ui/hdc_colors.dart';",
    "import '../../core/ui/hdc_colors.dart';\nimport '../../core/ui/hdc_location_picker.dart';",
)
replace_once(
...
# Role applications: location/work-premises fields are selection-only.
replace_once(
    'lib/features/roles/platform_role_application_form_screen.dart',
    "import '../../core/ui/hdc_colors.dart';",
...
# Private dashboard entry point for owner/super-admin/admin platform-role controls.
replace_once(
...
print('Build 24.2 wiring applied successfully.')
